"""Ladder entry point for AI Arena.

Lets python-sc2 connect to a LadderManager game:
...
def run_ladder_game(bot):
    ...
    # ares reads this to pick an opening per opponent (see zerg_builds.yml)
...
async def join_ladder_game(
    ...
    """Modified sc2.main._join_game: custom host/port, no extra sc2process."""
