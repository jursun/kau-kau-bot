...
Narrow it to targeted testing with `--map`/`--opponent`/`--difficulty`.
    ...
    python scripts/quick_tier.py --build "2base Chargelot All-In"
    python scripts/quick_tier.py --build "2base Chargelot All-In" --opponent Zerg
"""
...
from scripts.harness_common import QUICK, run_tier  # noqa: E402
